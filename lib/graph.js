...
class Graph {
    ...
    removeEdge(edge) {
        let ei = this.#edges.findIndex(e => e == edge)
        if (ei != -1) {
            this.#edges.splice(ei, 1)
            const v1 = edge.vertexStart
            const v2 = edge.vertexEnd
            const ei1 = v1.edgesOut.findIndex(e => e == edge)
            const ei2 = v2.edgesIn.findIndex(e => e == edge)
            v1.edgesOut.splice(ei1, 1)
            v2.edgesIn.splice(ei2, 1)
        }
    }
